...
Protocol:
  ...
  4. Freely shift weight left/right, but this time FASTER than what
     feels naturally comfortable - a deliberately brisk pace.
...
def main():
    ...
    pygame.display.set_caption("Preferred Frequency Task - FAST")
    ...
    csv_path = f"preferred_freq_fast_log_{ts}.csv"
    ...
    instruction_lines = [
        ...
        "but FASTER than what feels naturally comfortable to you -",
        f"a deliberately brisk pace, for {int(RECORD_SECONDS)} seconds.",
        "",
    ...
    if cycle_frequencies:
        ...
        summary_path = f"preferred_freq_fast_summary_{ts}.csv"
